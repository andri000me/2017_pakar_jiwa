...
$gejala = $_GET['gejala'];
$sql = " select distinct kd_gejala3, gejala3 from vw_relasi where kd_gejala1 = '$level1' and kd_gejala2 = '$level2' and kd_gejala3 = '$gejala' order by gejala3 asc limit 1";
...
<html>
    ...
    <body>
        ...
        <form action="?page=konsulcekpertama" method="post" name="form1" target="_self">
            <input type="hidden" name="level3" value="1">
            <p>&nbsp;</p>
