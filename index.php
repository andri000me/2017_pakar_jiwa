        ...
        <table width="1153" height="827" border="1" cellpadding="2" bordercolor="#666666">
            ...
            <tr>
                <td width="245" height="565" valign="top"><ul id="css3menu100" class="topmenu">
                        ...
                        <li class="topmenu"><a href="#" style="width:223px;height:49px;line-height:49px;"><span><img src="CSS3 MenuPAKARver1_files/css3menu100/service1.png" alt=""/>MENU PAKAR</span></a>
                            <ul>
                                <li class="subfirst"><a href="pakar/login.php" target="_blank"><img src="CSS3 MenuPAKARver1_files/css3menu100/256base-buy.png" alt=""/>LOGIN PAKAR</a></li>
                            </ul></li>

                        <li class="toplast"><a href="#" style="width:223px;height:48px;line-height:48px;"><span><img src="CSS3 MenuPAKARver1_files/css3menu100/help.png" alt=""/>BANTUAN</span></a>
                            <ul>
                                <li class="subfirst"><a href="?page=tolong"><img src="CSS3 MenuPAKARver1_files/css3menu100/help4.png" alt=""/>PENJELASAN</a></li>
                                <li><a href="?page=tentang"><img src="CSS3 MenuPAKARver1_files/css3menu100/bfavour1.png" alt=""/>PROFIL</a></li>
                            </ul></li>
                    </ul><p class="_css3m"><a href="http://css3menu.com/">Create A Menu In HTML  Css3Menu.com</a>
                        <!-- End css3menu.com BODY section -->

                </td>


                <td width="901" align="center" valign="top"><div style="height:600px; overflow:auto">
                        <?php
